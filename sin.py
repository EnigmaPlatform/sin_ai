...
class VocabularyLearningSystem:
            ...
            if self.wiktionary_parser:
                try:
                    ...
                    if word_data and word_data[0]:
                        ...
                        for example in word_data[0].get('examples', []):
    ...
    def _parse_definition(self, html_content, word):
        ...
        try:
            ...
            for header in headers:
                if header.get_text().strip() == 'Русский':
            ...
            while current_element and current_element.name not in ['h2', 'h3']:
                if current_element.name == 'p' and 'значение' in current_element.get_text().lower():
                    # Извлекаем текст определения
                    definition_text = current_element.get_text().strip()
            ...
            return {
                ...
                'definitions': definitions[:3],  # Максимум 3 определения
                'examples': examples[:5],  # Максимум 5 примеров
                'source': 'Wiktionary (ручной парсинг)'
            }
    ...
    def _extract_examples(self, soup, start_section):
        ...
        try:
            ...
            example_sections = soup.find_all(['dd', 'blockquote'])
...
"""
    ...
    def _learn_words_command(self, args):
        ...
        if self.network.vocabulary_system.learning_active:
    ...
    def _show_comprehensive_report(self):
        ...
        print(f"  Ошибок поиска: {vocab['failed_lookups']}")
